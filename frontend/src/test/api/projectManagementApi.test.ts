...
const handlers = [
  ...
  http.patch<never, UserUpdateRequest>(
  ...
  http.put<never, UserUpdateRequest>(
    `${API_BASE_URL}/users/me`,
    async ({ request }) => {
      const authHeader = request.headers.get('authorization')
      if (!authHeader) {
  ...
  http.post<never, WorkspaceCreateRequest>(
  ...
  http.put<{ id: string }, WorkspaceUpdateRequest>(
  ...
  http.post<never, ProjectCreateRequest>(
  ...
  http.put<{ id: string }, ProjectUpdateRequest>(
  ...
  http.post<never, TaskCreateRequest>(
    `${API_BASE_URL}/tasks`,
    async ({ request }) => {
      const authHeader = request.headers.get('authorization')
      if (!authHeader) {
  ...
  http.put<{ id: string }, TaskUpdateRequest>(
  ...
  http.post<{ taskId: string }, CommentCreateRequest>(
