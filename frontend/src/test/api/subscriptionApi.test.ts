...
const handlers = [
  ...
  http.get(
    `${SUBSCRIPTIONS_BASE_URL}/organizations/:orgId`,
    ({ params, request }) => {
  ...
  http.get(
    `${SUBSCRIPTIONS_BASE_URL}/organizations/:orgId/statistics`,
    ({ params }) => {
      if (params.orgId !== mockSubscription.organizationId) {
        return HttpResponse.json(
  ...
  http.get(
    `${SUBSCRIPTIONS_BASE_URL}/organizations/:orgId/invoices`,
    ({ params }) => {
      if (params.orgId !== mockSubscription.organizationId) {
        return HttpResponse.json(
          { message: 'Organization not found' },
  ...
  http.put(
    `${SUBSCRIPTIONS_BASE_URL}/:id/plan`,
  ...
  http.post(
    `${SUBSCRIPTIONS_BASE_URL}/:id/cancel`,
    async ({ params, request }) => {
      const body = (await request.json()) as any
  ...
  http.post(
    `${SUBSCRIPTIONS_BASE_URL}/:id/reactivate`,
    async ({ params, request }) => {
      const body = (await request.json()) as any
...
describe('Subscription API', () => {
  ...
  describe('GET /subscriptions/organizations/:orgId', () => {
    it('should fetch organization subscription', async () => {
      ...
      const result = await store.dispatch(
        subscriptionApi.endpoints.getOrganizationSubscription.initiate(
          mockOrganizationId
        )
      )
  ...
  describe('GET /subscriptions/organizations/:orgId/invoices', () => {
    it('should fetch organization invoices', async () => {
      ...
      const result = await store.dispatch(
        subscriptionApi.endpoints.getOrganizationInvoices.initiate(
          mockOrganizationId
        )
      )
  ...
  describe('GET /subscriptions/organizations/:orgId/statistics', () => {
    it('should fetch subscription statistics', async () => {
      ...
      const result = await store.dispatch(
        subscriptionApi.endpoints.getSubscriptionStatistics.initiate(
          mockOrganizationId
        )
      )
