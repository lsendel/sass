...
export const isValidOAuth2Provider = (provider: string): provider is OAuth2ProviderName => {
  return ['google', 'github', 'microsoft'].includes(provider);
};

// OAuth2 Constants
export const OAUTH2_PROVIDERS: OAuth2ProviderName[] = ['google', 'github', 'microsoft'];
