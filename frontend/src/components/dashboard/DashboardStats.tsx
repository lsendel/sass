      ...
      {stats.map((stat) => {
        ...
        return (
          <StatsCard
            ...
            value={stat.isLoading ? <InlineLoading size={DASHBOARD_CONSTANTS.LOADING.INLINE_SIZE} /> : stat.value}
...
export const useStatsData = (
  ...
  return React.useMemo(() => [
    ...
    },
    {
      ...
      value: paymentStats && typeof paymentStats.totalAmount === 'number'
  ...
  ], [organizations, paymentStats, subscriptionStats, paymentStatsLoading, subscriptionStatsLoading]);
};
