...
export const AuditLogDetailModal: React.FC<AuditLogDetailModalProps> = ({
  ...
  const {
    ...
    error,
    isLoading,
  } = useGetAuditLogDetailQuery(entryId!, {
    skip: !entryId || !isOpen,
  })
          ...
          {detail && (
            <div className="space-y-6">
                ...
                <div className="bg-gray-50 rounded-md p-4 space-y-3">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <div>
                        <span
                          className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full ${getOutcomeBadgeClass(detail.outcome)}`}
                        >
                          {detail.outcome}
                        </span>
                      </div>
                ...
                <div className="bg-gray-50 rounded-md p-4 space-y-3">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <div>
                        <span
                          className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full ${getSensitivityBadgeClass(detail.sensitivity)}`}
                        >
                          {detail.sensitivity}
                        </span>
                      </div>
              ...
              {detail.additionalData &&
                Object.keys(detail.additionalData).length > 0 && (
                  <div>
                    <h4 className="text-sm font-medium text-gray-900 mb-3">
                      Additional Data
                    </h4>
