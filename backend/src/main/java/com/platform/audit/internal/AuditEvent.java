...
/**
 * AuditEvent entity for compliance and security audit logging with GDPR support.
 * Uses table partitioning for performance and retention management.
 */
@Entity
...
public class AuditEvent {
    ...
    public AuditEvent(UUID organizationId, UUID actorId, String eventType, String resourceType,
                     String resourceId, String action, String ipAddress, String userAgent) {
    ...
    public static AuditEvent organizationCreated(UUID actorId, UUID organizationId, Map<String, Object> details) {
    ...
    public static AuditEvent subscriptionCreated(UUID actorId, UUID organizationId, UUID subscriptionId, Map<String, Object> details) {
    ...
    public static AuditEvent paymentProcessed(UUID actorId, UUID organizationId, UUID paymentId, Map<String, Object> details) {
    ...
    public static AuditEvent dataExported(UUID actorId, UUID organizationId, String exportType, Map<String, Object> details) {
    ...
    public static AuditEvent dataDeleted(UUID actorId, UUID organizationId, String resourceType, UUID resourceId, Map<String, Object> details) {
