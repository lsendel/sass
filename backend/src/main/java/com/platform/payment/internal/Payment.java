...
public class Payment {
    ...
    public Payment(UUID organizationId, String stripePaymentIntentId, Money amount, String currency, String description) {
    ...
    // Factory methods
    public static Payment createForInvoice(UUID userId, UUID invoiceId,
                                         String stripePaymentIntentId, Money amount) {
