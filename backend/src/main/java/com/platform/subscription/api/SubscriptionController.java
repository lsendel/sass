...
public class SubscriptionController {
    ...
    public ResponseEntity<SubscriptionResponse> getOrganizationSubscription(@PathVariable UUID organizationId) {
        try {
            Optional<Subscription> subscription = subscriptionService.findByOrganizationId(organizationId);
            return subscription.map(sub -> ResponseEntity.ok(SubscriptionResponse.fromSubscription(sub)))
    ...
    public ResponseEntity<SubscriptionResponse> reactivateSubscription(
        ...
        try {
            Subscription subscription = subscriptionService.reactivateSubscription(request.organizationId());
            SubscriptionResponse response = SubscriptionResponse.fromSubscription(subscription);
            return ResponseEntity.ok(response);
    ...
    public ResponseEntity<SubscriptionStatisticsResponse> getSubscriptionStatistics(@PathVariable UUID organizationId) {
        try {
            SubscriptionService.SubscriptionStatistics stats = subscriptionService.getSubscriptionStatistics(organizationId);
    ...
    public ResponseEntity<List<InvoiceResponse>> getOrganizationInvoices(@PathVariable UUID organizationId) {
        try {
        ...
        public static SubscriptionResponse fromSubscription(Subscription subscription) {
            return new SubscriptionResponse(
                ...
                subscription.getCurrentPeriodStart() != null ?
                    subscription.getCurrentPeriodStart().atStartOfDay(java.time.ZoneOffset.UTC).toInstant() : null,
                subscription.getCurrentPeriodEnd() != null ?
                    subscription.getCurrentPeriodEnd().atStartOfDay(java.time.ZoneOffset.UTC).toInstant() : null,
                subscription.getTrialEnd() != null ?
                    subscription.getTrialEnd().atStartOfDay(java.time.ZoneOffset.UTC).toInstant() : null,
        ...
        public static InvoiceResponse fromInvoice(Invoice invoice) {
            return new InvoiceResponse(
                ...
                invoice.getDueDate() != null ?
                    invoice.getDueDate().atStartOfDay(java.time.ZoneOffset.UTC).toInstant() : null,
                invoice.getPaidAt(),
    ...
    public record SubscriptionStatisticsResponse(
        ...
        public static SubscriptionStatisticsResponse fromStatistics(SubscriptionService.SubscriptionStatistics stats) {
