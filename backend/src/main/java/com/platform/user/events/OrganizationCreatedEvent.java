...
/**
 * Domain event published when an organization is created. This event can be consumed by other
 * modules (like audit) to perform additional processing when organizations are created.
 */
