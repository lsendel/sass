...
public class OrganizationController {
    ...
    public ResponseEntity<OrganizationResponse> createOrganization(@Valid @RequestBody CreateOrganizationRequest request) {
        ...
        return ResponseEntity.status(HttpStatus.CREATED).body(OrganizationResponse.fromOrganization(organization));
    }
    ...
    public ResponseEntity<OrganizationResponse> getOrganization(@PathVariable UUID organizationId) {
        ...
        return organization.map(org -> ResponseEntity.ok(OrganizationResponse.fromOrganization(org)))
    ...
    public ResponseEntity<OrganizationResponse> updateSettings(
        ...
        Organization organization = organizationService.updateSettings(organizationId, request.settings());
        return ResponseEntity.ok(OrganizationResponse.fromOrganization(organization));
    }
    ...
    public ResponseEntity<List<OrganizationMemberInfoResponse>> getMembers(@PathVariable UUID organizationId) {
        List<OrganizationService.OrganizationMemberInfo> members = organizationService.getOrganizationMembers(organizationId);
        List<OrganizationMemberInfoResponse> responses = members.stream()
            .map(OrganizationMemberInfoResponse::fromMemberInfo)
            .toList();
        return ResponseEntity.ok(responses);
    }
    ...
    public ResponseEntity<InvitationResponse> inviteUser(
        ...
        Invitation invitation = organizationService.inviteUser(
            organizationId,
            request.email(),
            request.role()
        );
        return ResponseEntity.status(HttpStatus.CREATED).body(InvitationResponse.fromInvitation(invitation));
    }
    ...
    public ResponseEntity<List<InvitationResponse>> getPendingInvitations(@PathVariable UUID organizationId) {
    ...
    public ResponseEntity<OrganizationMemberResponse> updateMemberRole(
        ...
        OrganizationMember member = organizationService.updateMemberRole(
            organizationId,
            userId,
            request.role()
        );
    ...
    public record OrganizationMemberInfoResponse(
        ...
        public static OrganizationMemberInfoResponse fromMemberInfo(OrganizationService.OrganizationMemberInfo info) {
