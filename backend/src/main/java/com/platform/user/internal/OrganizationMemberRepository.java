...
public interface OrganizationMemberRepository extends JpaRepository<OrganizationMember, UUID> {
     ...
     */
    List<OrganizationMember> findByOrganizationIdAndRole(UUID organizationId, OrganizationMember.Role role);

    /**
     * Find members by organization and status
     */
    List<OrganizationMember> findByOrganizationIdAndStatus(UUID organizationId, OrganizationMember.Status status);
     ...
     */
    @Query("SELECT om FROM OrganizationMember om WHERE om.organizationId = :organizationId AND om.role = 'OWNER'")
     ...
     */
    @Query("SELECT om FROM OrganizationMember om WHERE om.organizationId = :organizationId AND om.status = 'ACTIVE'")
    ...
    List<OrganizationMember> findMemberInfoByOrganization(@Param("organizationId") UUID organizationId);
     ...
     */
    @Query("SELECT COUNT(om) FROM OrganizationMember om WHERE om.organizationId = :organizationId AND om.role = 'OWNER'")
