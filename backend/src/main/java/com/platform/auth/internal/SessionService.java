...
public class SessionService {
     ...
     */
    public AuthenticationResult handleOAuth2Authentication(OAuth2User oauth2User,
                                                          String ipAddress,
                                                          String userAgent) {
    ...
    public SessionInfo getSessionInfo(UUID userId) {
        ...
        Instant lastActivity = userRepository.findById(userId)
    ...
    private User updateUserIfNeeded(User existingUser, String email, String name,
        ...
        if (!provider.equals(existingUser.getProvider()) ||
            ...
            logger.info("User {} authenticated with different provider: {} (was: {})",
    ...
    private User createNewUser(String email, String name, String provider, String providerId) {
        ...
        logger.info("Created new user: {} with email: {} via provider: {}",
