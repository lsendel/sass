...
/**
 * OAuth2 Audit Event entity for compliance logging and security monitoring Records all
 * OAuth2-related activities for audit trails and forensic analysis
 *
 * <p>This entity supports GDPR compliance by tracking user consent and data processing activities
 * while providing comprehensive audit trails for security monitoring.
 */
@Entity
@Table(
    name = "oauth2_audit_events",
    indexes = {
  ...
  private static AuditSeverity determineSeverity(OAuth2EventType eventType) {
    return switch (eventType) {
      case AUTHORIZATION_FAILED,
          ...
          TOKEN_VALIDATION_FAILED,
          PKCE_VALIDATION_FAILED,
          STATE_VALIDATION_FAILED -> AuditSeverity.ERROR;
