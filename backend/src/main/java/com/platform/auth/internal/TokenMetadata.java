...
/**
 * TokenMetadata entity for secure session and opaque token management. Implements the
...
public class TokenMetadata {
  ...
  public TokenMetadata(
      final UUID userId, final String tokenHash, final String salt, final Instant expiresAt) {
    this.userId = userId;
  ...
  // Factory methods
  public static TokenMetadata createWebSession(
      final UUID userId,
  ...
  public static TokenMetadata createApiToken(
      final UUID userId,
      final String tokenHash,
      final String salt,
      final Instant expiresAt,
  ...
  public static TokenMetadata createOAuthSession(
      final UUID userId,
      final String tokenHash,
      final String salt,
      final Instant expiresAt,
  ...
  public boolean isFromSameDevice(final String ipAddress, final String userAgent) {
    return ipAddress != null
        && ipAddress.equals(getIpAddress())
        && userAgent != null
        && userAgent.equals(getUserAgent());
  }
