...
public class TokenMetadata {
    ...
    public TokenMetadata(UUID userId, String tokenHash, String salt, Instant expiresAt) {
        this.userId = userId;
    ...
    // Factory methods
    public static TokenMetadata createWebSession(UUID userId, String tokenHash, String salt,
    ...
    public static TokenMetadata createApiToken(UUID userId, String tokenHash, String salt,
                                             Instant expiresAt, String apiKeyName) {
        var token = new TokenMetadata(userId, tokenHash, salt, expiresAt);
    ...
    public static TokenMetadata createOAuthSession(UUID userId, String tokenHash, String salt,
                                                 Instant expiresAt, String oauthProvider,
                                                 String ipAddress) {
        var token = new TokenMetadata(userId, tokenHash, salt, expiresAt);
    ...
    // Security methods
    public boolean isFromSameDevice(String ipAddress, String userAgent) {
