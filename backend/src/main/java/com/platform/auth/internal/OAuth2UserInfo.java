...
/**
 * OAuth2 User Information entity storing user profile data from OAuth2 providers Contains
 * standardized user information retrieved from Google, GitHub, Microsoft, etc.
 *
 * <p>This entity stores user information in a provider-agnostic format while preserving the
 * original provider-specific data for audit and debugging purposes.
 */
@Entity
@Table(
    name = "oauth2_user_info",
    uniqueConstraints = {
...
public class OAuth2UserInfo {
  ...
  /**
   * User identifier from the OAuth2 provider (sub claim in OpenID Connect) This is the stable,
  ...
  /**
   * Original raw user information from the OAuth2 provider as JSON Preserved for audit purposes and
  ...
  /**
   * Checks if this user info needs refresh from the provider Based on last update time and provider
   * policies
   */
