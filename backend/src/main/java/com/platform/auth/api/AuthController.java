...
public class AuthController {
    ...
    public AuthController(OAuth2ProvidersService providersService,
    ...
    public ResponseEntity<Map<String, Object>> listProviders() {
        try {
            ...
            return ResponseEntity.ok(Map.of(
                "providers", providers.stream().map(OAuth2ProvidersService.OAuth2ProviderInfo::toMap).toList()
            ));
        } catch (Exception e) {
    ...
    public void initiateAuthorization(@RequestParam String provider,
        ...
        try {
            ...
            logger.info("Initiating OAuth2 authorization for provider: {} with redirect: {}",
    ...
    public ResponseEntity<Map<String, Object>> getCurrentSession(
        ...
        try {
            ...
            return ResponseEntity.ok(Map.of(
                ...
                "organization", userPrincipal.hasOrganizationContext() ? Map.of(
     ...
     */
    @PostMapping("/logout")
    public ResponseEntity<Void> logout(@AuthenticationPrincipal PlatformUserPrincipal userPrincipal,
                                     HttpServletRequest request) {
    ...
    private String buildAuthorizationUrl(String provider, String redirectUri, String state) {
        ...
        return baseUrl + "?redirect_uri=" + URLEncoder.encode(redirectUri, StandardCharsets.UTF_8)
