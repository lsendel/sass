...
Defined in: frontend/node\_modules/@testing-library/dom/types/pretty-dom.d.ts:3
...
Defined in: frontend/node\_modules/@testing-library/dom/types/pretty-dom.d.ts:8
