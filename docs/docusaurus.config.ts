...
const config: Config = {
  title: 'Spring Boot Modulith Payment Platform',
  tagline: 'Production-ready payment processing with modular architecture',
  ...
  themeConfig: {
    ...
    algolia: {
      ...
      // Optional: Replace parts of the item URLs to navigate to the right page
