...
_Ready-to-use code patterns and templates for the Spring Boot Modulith Payment Platform Frontend_
...
export class ErrorHandler {
  ...
  getErrorStats() {
    ...
    return {
      ...
      errorsByType: this.errorLog.reduce(
        (acc, error) => {
      ...
      errorsBySeverity: this.errorLog.reduce(
        (acc, error) => {
